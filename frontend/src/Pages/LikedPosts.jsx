  ...
  return (
    <Container>
      <div className="max-w-7xl mx-auto py-10 px-4">
        <h1 className="text-4xl font-bold mb-8">Liked Posts</h1>
        ...
        {posts.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl shadow p-10 text-center">
            <h2 className="text-2xl font-semibold mb-3">No liked posts yet</h2>
            <p className="text-gray-500">Like posts to add them to this page.</p>
          </div>
        )}
      </div>
    </Container>
